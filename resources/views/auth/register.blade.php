...
<head>
    ...
    <meta name="link-api" link="{{ url('/api/register') }}">
</head>
...
<body>
        ...
        <div class="card-body">
            <form id="formRegister">
                ...
                <div class="mb-3 form-check">
                    ...
                    <label class="form-check-label" for="check_password">Lihat Password</label>
                </div>
    ...
    <script src="{{ url('js/cookie/main.js') }}"></script>
    <script src="{{ url('js/cookie/index.min.js') }}"></script>
</body>
